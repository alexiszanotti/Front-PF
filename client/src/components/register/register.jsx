...
export default function Register() {
    ...
    const inputHandleChange = (e) => {
        ...
        else if(e.target.name === 'lastName') setValues({ ...values, [e.target.name]: e.target.value });
    ...
    const handleSubmitCreate = () => {
        ...
        if(values.name === '' || values.lastName === '' || values.gender === '' || values.birthDay === '' || values.userName === '' || values.password === '') return alert('Hay campos vacios');
    ...
    return (
        ...
        <div className='contReg' >
            ...
            >
                ...
                <TextField name='name' id="name" label="Nombre" variant="outlined" onChange={e => inputHandleChange(e) } />

                <TextField name='lastName' id="lastName" label="Apellido" variant="outlined" onChange={e => inputHandleChange(e) } />
