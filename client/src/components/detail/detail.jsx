    ...
    <div>
      <form onSubmit={e => (e)}>
        <div className="detailContainer1">
          ...
          <div >
            <button type='submit' onClick={handleSubmit} className="btn1">Publicar</button>
            <button type='submit' onClick={() => openCloseModal()} className="btn2">Cerrar</button>
          </div>
        </div>
      </form>
    </div>
  ...
  return (
    <div className="container">
      ...
      <div className="detailContainer">
        ...
        {
          reseña === undefined || reseña.length === 0 ? <h4>No hay reseñas</h4> :
            reseña.map((product) => {
              return (
                <div>
